...
var providerFieldRules = []fieldRule{
	...
	newFieldRule(sources.ResourceTypeProvider, "Credentials"),
	newFieldRule(sources.ResourceTypeProvider, "Advisories"),
	newFieldRule(sources.ResourceTypeProvider, "Catalog"),
	newFieldRule(sources.ResourceTypeProvider, "Invocation"),
