...
type Result struct {
	...
	// ProviderAPICounts tracks model counts from provider APIs
	ProviderAPICounts map[catalogs.ProviderID]int

	// ModelProviderMap maps model IDs to their provider IDs
...
func (b *ResultBuilder) WithChangeset(changeset *differ.Changeset) *ResultBuilder {
	b.result.Changeset = changeset
	return b
}

// WithAppliedChanges sets the applied changes
func (b *ResultBuilder) WithAppliedChanges(changeset *differ.Changeset) *ResultBuilder {
...
func (b *ResultBuilder) WithSources(sources ...sources.Type) *ResultBuilder {
...
func (b *ResultBuilder) WithProvenance(provenance provenance.Map) *ResultBuilder {
