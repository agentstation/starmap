...
func TestGenerateModelIndexLargeFamilies(t *testing.T) {
	...
	// Check for italic text - markdown library may use _ or *
	assert.True(t, strings.Contains(contentStr, "_...and 5 more_") || strings.Contains(contentStr, "*...and 5 more*"),
		"Should contain italic '...and 5 more' text")
}
