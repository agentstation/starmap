...
func sampleValues() map[string]string {
	return map[string]string{
		...
		settings.GenerationPin:                           "retained-generation",
		settings.RetentionEnabled:                        "false",
		settings.RetentionInterval:                       "2h",
		settings.RetentionMaxGenerations:                 "7",
		settings.RetentionMaxBytes:                       "123456",
		settings.RetentionScanEntries:                    "99",
		settings.RetentionInputMaxBytes:                  "789012",
