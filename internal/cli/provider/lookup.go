...
func Get(catalog catalogs.Reader, providerID string) (*catalogs.Provider, error) {
...
func List(catalog catalogs.Reader) []*catalogs.Provider {
...
func GetWithValidation(catalog catalogs.Reader, providerID string, hasClientFunc func(catalogs.ProviderID) bool) (*catalogs.Provider, error) {
