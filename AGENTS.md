...
- Use Go 1.27 language and library features when they improve directness.
...
- **Providers**: OpenAI, Anthropic, Google AI/Vertex, Groq, DeepSeek, Cerebras, Hetzner, Alibaba Cloud, Fireworks AI, DeepInfra
