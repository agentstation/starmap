...
are complete. P4.7 now owns observation health and non-authoritative absence
after explicit field presence was preserved end to end.
...
| P4.7 | `IN_PROGRESS` | Consume observation health and make absence non-authoritative | Reconciliation consumes source status, completeness, issues, and volume history; complete omission, partial response, timeout, fetch failure, and suspicious volume collapse cannot hard-delete or retire |
