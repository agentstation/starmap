...
and P3.1–P3.3 are complete. P3.4 is the sole active task and proves that a new
verified embedded revision reconciles into an existing human workspace without
overwriting actual human edits.
...
| P3.4 | `IN_PROGRESS` | Reconcile embedded E1→E2 after P4 | New embedded revision updates unchanged embedded-derived fields, fills gaps, and preserves actual human edits using the completed P4 authority/provenance model |
