...
are complete. P4.1 now owns consolidation of authority policy before the
remaining authority, provenance, presence, and resilience work.
...
| P4.2 | `IN_PROGRESS` | Enforce provider pricing authority | Valid provider price wins atomically for its offering; invalid price records durable rejection evidence and falls back; rejection evidence remains when every candidate is invalid |
