...
Status: `IN_PROGRESS` — P0–P5 and P6.1–P6.4 are complete. P6.5 is the sole
...
and broad application/provenance/source contracts were replaced by concrete
products or consumer-local roles.
