...
| P4.3 | `IN_PROGRESS` | Make local data fallback | Dynamic valid facts beat local for discoverable fields; manual missing data and operator configuration survive |
