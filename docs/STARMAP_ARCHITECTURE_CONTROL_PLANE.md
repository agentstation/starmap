...
are complete. P4.6 now owns explicit presence semantics after source identity
was preserved through the human YAML workspace.
...
| P4.6 | `IN_PROGRESS` | Model presence explicitly | Tri-state or equivalent typed representation makes missing, explicit false, explicit zero, empty, and unknown round-trip distinctly for limits, features, and other affected fields |
