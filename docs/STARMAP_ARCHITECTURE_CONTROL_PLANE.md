...
and P3.1–P3.2 are complete. P3.3 is the sole active task and proves atomic
first-explicit-update creation of the canonical human catalog workspace.
...
| P3.3 | `IN_PROGRESS` | Make first-run seed atomic | Missing workspace becomes one complete embedded-seeded tree or remains absent after failure |
