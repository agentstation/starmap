...
are complete. P4.5 now owns preservation of source identity through the human
YAML workspace after provider/model-scoped durable provenance was established.
...
| P4.5 | `IN_PROGRESS` | Preserve source identity through YAML | Reloading generated YAML does not relabel unchanged provider/models.dev/embedded values as local |
