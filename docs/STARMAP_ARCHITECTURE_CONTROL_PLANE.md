...
Status: `IN_PROGRESS` — P0 and P1 are complete. P2.2 has pinned the current
local-workspace and generation-store defects; P2.3 is characterizing
reconciliation loss before any structural implementation begins.
