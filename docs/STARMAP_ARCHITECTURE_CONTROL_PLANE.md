...
Status: `IN_PROGRESS` — P0 and P1 are complete. P2.2–P2.6 have pinned current
behavior and frozen the public-composition budget; P2.7 is freezing the five
user journeys before structural implementation begins.
...
| P2.7 | `IN_PROGRESS` | Freeze user journeys | Golden fixtures cover in-process library, CLI workspace, embedded upgrade, embeddable server, and remote reactive consumer |
