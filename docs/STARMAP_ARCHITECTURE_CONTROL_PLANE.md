...
Status: `IN_PROGRESS` — P0 and P1 are complete. P2.2–P2.3 have pinned the
current workspace, store, and reconciliation-loss defects; P2.4 is
characterizing whole-collection schema failure before structural
