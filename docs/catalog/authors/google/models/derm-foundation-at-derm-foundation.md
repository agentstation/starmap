...
[Catalog](../../../..) / [Authors](../../..) / [Google](../..) / **Derm Foundation**
...
| Specification | Value |
|---------|---------|
| **Model ID** | `derm-foundation@derm-foundation` |
...
|---------|---------|---------|---------|
| [Google Vertex AI](../../../providers/google-vertex/models/derm-foundation-at-derm-foundation) | — | — |  |
