...
[Catalog](../../../..) / [Authors](../../..) / [Google](../..) / **Cxr Foundation**
...
| Specification | Value |
|---------|---------|
| **Model ID** | `cxr-foundation@cxr-foundation` |
...
|---------|---------|---------|---------|
| [Google Vertex AI](../../../providers/google-vertex/models/cxr-foundation-at-cxr-foundation) | — | — |  |
