...
| Specification | Value |
|---------|---------|
| **Model ID** | `gemini-2.5-pro@default` |
...
|---------|---------|---------|---------|
| [Google AI Studio](../../../providers/google-ai-studio/models/gemini-2.5-pro-at-default) | — | — |  |
| [Google Vertex AI](../../../providers/google-vertex/models/gemini-2.5-pro-at-default) | — | — |  |
