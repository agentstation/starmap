...
[Catalog](../../../..) / [Authors](../../..) / [Google](../..) / **Path Foundation**
...
| Specification | Value |
|---------|---------|
| **Model ID** | `path-foundation@path-foundation` |
...
|---------|---------|---------|---------|
| [Google Vertex AI](../../../providers/google-vertex/models/path-foundation-at-path-foundation) | — | — |  |
