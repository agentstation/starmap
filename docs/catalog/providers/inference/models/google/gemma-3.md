...
[Catalog](../../../../..) / [Providers](../../../..) / [inference](../../..) / **Google Gemma 3**
...
| Document summary (10K in, 1K out) | 10k tokens | 1k tokens | $0.001800 |
| RAG query (50K in, 2K out) | 50k tokens | 2k tokens | $0.008100 |
...
```
Cost = (Input Tokens / 1M × $0.15) + (Output Tokens / 1M × $0.30)
```
