...
[Catalog](../../../..) / [Providers](../../..) / [inception](../..) / **Mercury Coder**
...
| RAG query (50K in, 2K out) | 50k tokens | 2k tokens | $0.0145 |
| Code generation (5K in, 10K out) | 5k tokens | 10k tokens | $0.0112 |

  
**Pricing Formula:**
  
```
Cost = (Input Tokens / 1M × $0.25) + (Output Tokens / 1M × $1.00)
```
