...
[Catalog](../../../../..) / [Providers](../../../..) / [Groq](../../..) / **llama-4-scout-17b-16e-instruct**
...
|---------|---------|---------|---------|
| Quick chat (1K in, 500 out) | 1k tokens | 500 tokens | $0.000280 |
| Document summary (10K in, 1K out) | 10k tokens | 1k tokens | $0.001440 |
| RAG query (50K in, 2K out) | 50k tokens | 2k tokens | $0.006180 |
| Code generation (5K in, 10K out) | 5k tokens | 10k tokens | $0.003950 |

  
**Pricing Formula:**
  
```
Cost = (Input Tokens / 1M × $0.11) + (Output Tokens / 1M × $0.34)
```
...
|---------|---------|---------|---------|
| Personal (10 chats/day) | 10 chats | 675k | $0.1260 |
| Small Team (100 chats/day) | 100 chats | 9.0M | $1.68 |
| Enterprise (1000 chats/day) | 1000 chats | 135.0M | $25.20 |
