...
[Catalog](../../../../..) / [Providers](../../../..) / [Groq](../../..) / **gpt-oss-120b**
...
|---------|---------|---------|---------|
| Quick chat (1K in, 500 out) | 1k tokens | 500 tokens | $0.000525 |
| Document summary (10K in, 1K out) | 10k tokens | 1k tokens | $0.002250 |
| RAG query (50K in, 2K out) | 50k tokens | 2k tokens | $0.009000 |
| Code generation (5K in, 10K out) | 5k tokens | 10k tokens | $0.008250 |

  
**Pricing Formula:**
  
```
Cost = (Input Tokens / 1M × $0.15) + (Output Tokens / 1M × $0.75)
```
...
|---------|---------|---------|---------|
| Personal (10 chats/day) | 10 chats | 675k | $0.2363 |
| Small Team (100 chats/day) | 100 chats | 9.0M | $3.15 |
| Enterprise (1000 chats/day) | 1000 chats | 135.0M | $47.25 |
