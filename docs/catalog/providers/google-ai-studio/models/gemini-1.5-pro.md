...
[Catalog](../../../..) / [Providers](../../..) / [Google AI Studio](../..) / **Gemini 1.5 Pro**
...
|---------|---------|---------|---------|
| Quick chat (1K in, 500 out) | 1k tokens | 500 tokens | $0.003750 |
| Document summary (10K in, 1K out) | 10k tokens | 1k tokens | $0.0175 |
| RAG query (50K in, 2K out) | 50k tokens | 2k tokens | $0.0725 |
| Code generation (5K in, 10K out) | 5k tokens | 10k tokens | $0.0563 |

  
**Pricing Formula:**
  
```
Cost = (Input Tokens / 1M × $1.25) + (Output Tokens / 1M × $5.00)
```
...
|---------|---------|---------|---------|
| Personal (10 chats/day) | 10 chats | 675k | $1.69 |
| Small Team (100 chats/day) | 100 chats | 9.0M | $22.50 |
| Enterprise (1000 chats/day) | 1000 chats | 135.0M | $337.50 |
